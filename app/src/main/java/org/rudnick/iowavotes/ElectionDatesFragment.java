 ...
 */
public class ElectionDatesFragment extends Fragment {

    public ElectionDatesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        electionArray.add(new Step("Schoolboard Election", "Date of Schoolboard election"));
